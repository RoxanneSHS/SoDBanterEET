...
Within the EET context, this approach separates SoD from the rest of the game where banters are done traditionally via dialogues. It disrupts the EET idea of a continuois game with continuos creatures and features.

This mod converts the major banters of the continuous NPCs into *old-style* dialogues that interrupt the game and require player interaction. About 80 longer conversations during SoD are thus restored and maybe recognised by players for the first time. Many of them deserve larger attention.
